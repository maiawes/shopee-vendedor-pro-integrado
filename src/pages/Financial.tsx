...
export default function Financial() {
  const { products, sales, purchases, expenses, payments, bankAccounts, bankTransactions, isLoading, error } = useFirebaseData();
  ...
  const maxCashFlow = Math.max(...cashFlow.flatMap((item) => [item.incoming, item.outgoing]), 1);
